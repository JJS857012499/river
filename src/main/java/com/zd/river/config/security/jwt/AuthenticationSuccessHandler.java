package com.zd.river.config.security.jwt;

import com.zd.river.common.annotation.SystemLog;
import com.zd.river.common.constant.SecurityConstant;
import com.zd.river.common.utils.IpInfoUtil;
import com.zd.river.common.utils.ResponseUtil;
...
public class AuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    @Value("${river.tokenExpireTime}")
    private Integer tokenExpireTime;

    @Value("${river.saveLoginTime}")
