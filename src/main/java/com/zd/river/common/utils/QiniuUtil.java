package com.zd.river.common.utils;
...
public class QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    @Value("${river.qiniu.accessKey}")
    private String accessKey;

    @Value("${river.qiniu.secretKey}")
    private String secretKey;

    @Value("${river.qiniu.bucket}")
    private String bucket;

    @Value("${river.qiniu.domain}")
    private String domain;

    @Value("${river.qiniu.zone}")
    ...
    public String qiniuUpload(String filePath, String key) {
        ...
        try {
            ...
            throw new RiverException("上传文件出错，请检查七牛云配置，" + r.toString());
        }
    }
    ...
    public String qiniuBase64Upload(String data64) {
        ...
        try {
            ...
            throw new RiverException("上传文件出错，请检查七牛云配置，" + e.toString());
        }
        return domain + "/" + key;
    }
