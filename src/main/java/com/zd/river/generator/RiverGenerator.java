package com.zd.river.generator;

import com.zd.river.generator.bean.EntityOfEntity;
...
public class RiverGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.zd.river.modules.base.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.zd.river.modules.base.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.zd.river.modules.base.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.zd.river.modules.base.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.zd.river.modules.base.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/zd/river/generator/template";
